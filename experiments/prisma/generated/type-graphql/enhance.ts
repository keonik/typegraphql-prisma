...
const inputsInfo = {
  ...
  ClientOrderByInput: ["id", "email", "firstName", "age", "accountBalance", "amount", "role", "grades", "aliases"],
  ...
  PostOrderByInput: ["uuid", "createdAt", "updatedAt", "published", "title", "subtitle", "content", "authorId", "editorId", "kind", "metadata"],
  ...
  MovieOrderByInput: ["directorFirstName", "directorLastName", "title"],
  ...
  ProblemOrderByInput: ["id", "problemText", "creatorId"],
  ...
  PostOrderByAggregateInput: ["count"],
  ...
  MovieOrderByAggregateInput: ["count"],
  ...
  CreatorOrderByAggregateInput: ["count"],
  ProblemListRelationFilter: ["every", "some", "none"],
  ProblemOrderByAggregateInput: ["count"],
...
const outputsInfo = {
  ...
  UserCountOutputType: ["posts", "editorPosts"],
  ...
  DirectorCountOutputType: ["movies"],
  ...
  ProblemCountOutputType: ["likedBy"],
  ...
  CreatorCountOutputType: ["likes", "problems"],
